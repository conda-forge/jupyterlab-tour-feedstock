...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jupyterlab-tour-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12153&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyterlab-tour-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyterlab-tour` can be installed with:

```
conda install jupyterlab-tour
```

It is possible to list all of the versions of `jupyterlab-tour` available on your platform with:
